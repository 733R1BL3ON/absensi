				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						...
						<li><a href="Rpl 1/index.php">RPL 1</a></li>
						  ...
						  <li><a href="index.php">ADM PERKANTORAN 1</a></li>
...
<?php
	...
	$query = $dbconnect->query("SELECT * FROM siswa WHERE jurusan ='Adm Perkantoran1' and kelas='XII' and nama LIKE '%".$cari."%' ");
?>
