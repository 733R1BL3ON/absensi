					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
						 <li><a href="../Rpl 1/index.php">RPL 1</a></li>
						  ...
						  <li><a href="index.php">ADM PERKANTORAN 2</a></li>
...
<?php
	...
	$query = $dbconnect->query("SELECT * FROM siswa WHERE jurusan ='Adm Perkantoran2' and kelas='XII' and nama LIKE '%".$cari."%' ");
?>
