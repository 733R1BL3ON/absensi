...
<?php
	...
	$query = $dbconnect->query("SELECT * FROM siswa WHERE jurusan ='Adm Perkantoran3' and kelas='X' and nama LIKE '%".$cari."%' ");
?>
	...
	<table class="table table-bordered table-striped table-hover">
		...
		<tbody>
			<tr>
				...
				<td><a class="btn btn-danger btn-sm" href="deletex.php?id=<?php echo $data['id'];?>" onclick="return confirm('Apakah anda yakin ingin menghapusnya?')">
