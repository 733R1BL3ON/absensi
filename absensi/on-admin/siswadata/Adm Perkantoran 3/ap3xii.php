				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
						  ...
						  <li><a href="../Rpl 2/index.php">RPL 2</a></li>
						  <li><a href="../Rpl 3/index.php">RPL 3</a></li>
						  <li><a href="../Multimedia 1/index.php">MULTIMEDIA 1</a></li>
						  <li><a href="../Multimedia 2/index.php">MULTIMEDIA 2</a></li>
						  ...
						  <li><a href="index.php">ADM PERKANTORAN 3</a></li>
...
<?php
	...
	$query = $dbconnect->query("SELECT * FROM siswa WHERE jurusan ='Adm Perkantoran3' and kelas='XII' and nama LIKE '%".$cari."%' ");
?>
	...
	<table class="table table-bordered table-striped table-hover">
		...
		<tbody>
			<tr>
				...
				<td><a class="btn btn-danger btn-sm" href="deletexii.php?id=<?php echo $data['id'];?>" onclick="return confirm('Apakah anda yakin ingin menghapusnya?')">
