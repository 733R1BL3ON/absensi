				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
						  ...
						  <li><a href="index.php">AKUTANSI 1</a></li>
...
<?php
	...
	$query = $dbconnect->query("SELECT * FROM siswa WHERE jurusan ='Akuntansi1' and kelas='X' and nama LIKE '%".$cari."%' ");
?>
