				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
						  ...
						  <li><a href="index.php">AKUTANSI 2</a></li>
...
<?php
	...
	$query = $dbconnect->query("SELECT * FROM siswa WHERE jurusan ='Akuntansi2' and kelas='XII' and nama LIKE '%".$cari."%' ");
?>
