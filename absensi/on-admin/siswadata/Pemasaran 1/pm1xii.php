				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
						  ...
						  <li><a href="index.php">PEMASARAN 1</a></li>
...
<?php
	...
	$query = $dbconnect->query("SELECT * FROM siswa WHERE jurusan ='Pemasaran1' and kelas='XII' and nama LIKE '%".$cari."%' ");
?>
