				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
						  ...
						  <li><a href="index.php">PEMASARAN 3</a></li>
						</ul>
					</li>
				</ul>
...
<?php
	...
	$query = $dbconnect->query("SELECT * FROM siswa WHERE jurusan ='Pemasaran3' and kelas='XII' and nama LIKE '%".$cari."%' ");
?>
