...
<body>
	<nav class="navbar navbar-default">
		...
		<div class="X">
			<a href="rpl1x.php" class="btn btn-primary">KELAS X</a>
		</div>
		<div class="XI">
			<a href="rpl1xi.php" class="btn btn-primary">KELAS XI</a>
		</div>
		<div class="XII">
			<a href="rpl1xii.php" class="btn btn-primary">KELAS XII</a>
		</div>
</body>
</html>