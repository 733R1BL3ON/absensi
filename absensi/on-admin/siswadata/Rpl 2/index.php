...
<body>
	<nav class="navbar navbar-default">
		...
		<div class="X">
			<a href="rpl2x.php" class="btn btn-primary">KELAS X</a>
		</div>
		<div class="XI">
			<a href="rpl2xi.php" class="btn btn-primary">KELAS XI</a>
		</div>
		<div class="XII">
			<a href="rpl2xii.php" class="btn btn-primary">KELAS XII</a>
		</div>
</body>
</html>