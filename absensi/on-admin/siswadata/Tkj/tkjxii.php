				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
						  ...
						  <li><a href="../Rpl 2/index.php">RPL 3</a></li>
						  ...
						  <li><a href="../Pemasaran 3/index.php">PEMASARAN 3</a></li>						</ul>
					</li>
				</ul>
...
<?php
	...
	$query = $dbconnect->query("SELECT * FROM siswa WHERE jurusan ='Tkj' and kelas='XII' and nama LIKE '%".$cari."%' ");
?>
