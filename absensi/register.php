...
<div class="head">
		<nav class="navbar navbar-default">
			...
			<li><a href="home.php" onClick="history.go(-1);"><span class="glyphicon glyphicon-circle-arrow-left"></span> Kembali</a></li>
			</ul>
			</div>
		</nav>
	</div>
		...
		<div class="body-register">
			<div class="col-lg-12">
			<form id="login-form" action="check-register-adm.php" method="post" role="form" style="display: block;">
				...
				<div class="form-group">
					...
					<input type="radio" id="opsi1" value="admin"  name="level" checked> Admin</input>
				<div class="form-group">
